      ...
      <div class="album py-5 bg-body-tertiary">
        <center>
          <a href="https://maps.app.goo.gl/KPBZMawqKXFsyss19">
              <img class="imgsvg" src="/our-brunches/svg/<?php ($lang == "en") ? print "en" : print "ar" ?>/alnofleen.svg" alt="">
          </a>
          <a href="https://maps.app.goo.gl/VvJ46zWdfpJabcJu5">
          <img class="imgsvg" src="/our-brunches/svg/<?php ($lang == "en") ? print "en" : print "ar" ?>/hayalandaluse.svg" alt="">      

          </a>
          <a href="https://maps.app.goo.gl/x4rXUNHJQHJNCBjm9">
          <img class="imgsvg" src="/our-brunches/svg/<?php ($lang == "en") ? print "en" : print "ar" ?>/aljraba.svg" alt="">      
          </a>
          <a href="https://maps.app.goo.gl/VgZ7aNaX3mvLcZst5">
          <img class="imgsvg" src="/our-brunches/svg/<?php ($lang == "en") ? print "en" : print "ar" ?>/alqadesiya.svg" alt="">
